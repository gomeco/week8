...
st.write(print("In totaal hebben " + str(roundedNumber1) + 
...
st.write(print("In totaal hebben " + str(roundedNumber2) + 
...
st.write(print("In totaal hebben " + str(roundedNumber3) + 
