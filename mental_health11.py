...
fig = px.histogram(df9, x = 'Age' , color = 'treatment' ,
...
fig = px.line(z, x='age_group', y='value', color='Gender',
                 labels={"age_group": "Leeftijd",
                     "value": "Aantal zelfmoorden",
                    "Gender": "Geslacht",
                 },
                title="Aantal zelfmoorden gebaseerd op leeftijd en geslacht")
...
predictlist = [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
...
suicide2 = pd.DataFrame()
suicide2['x'] = predictlist
suicide2['y'] = predictions
...
fig = plt.figure()
sns.regplot(data= suicide2, x='x', y='y', ci=None)
sns.scatterplot(data= suicide2, x='x', y='y', color = 'red', markers='s')
plt.title('Regressiemodel: Voorspelling voor aantal zelfmoorden (2015-2022)')
plt.xlabel('jaar')
plt.ylabel('Aantal zelfmoorden (Amerika)')
